...
import { Lock, Eye, EyeOff, ArrowLeft, CheckCircle2, XCircle, ShieldCheck, AlertTriangle } from "lucide-react";
...
// ─── Inner component (reads token from query param ?token=...) ────────────────
    ...
    return (
      <Card variant="glass" padding="lg" className="animate-slideUp">
        <div className="flex flex-col items-center gap-4 py-2 text-center">
          ...
          <div>
            <h2 className="text-xl font-bold text-white drop-shadow-lg">Invalid link</h2>
...
// ─── Page (Suspense required for useSearchParams in Next.js) ─────────────────
