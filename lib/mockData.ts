...
export const mockLeads: Lead[] = [
  {
    ...
    source: "email",
    sourceDetails:
      "From: john@abccorp.com\nSubject: Business Loan Inquiry — $50,000\n\nHi, I came across BusinessBlum online and I'm interested in applying for a business loan. My company ABC Corp has been operating for 3 years and we need around $50,000 to purchase new inventory and expand our warehouse space. Our monthly revenue is approximately $35,000. Could you let me know what the next steps are and whether we qualify? Thanks, John Smith",
    intent: "business_loan",
    fundingAmount: "$50,000",
    message:
      "Hi, I came across BusinessBlum online and I'm interested in applying for a business loan. My company ABC Corp has been operating for 3 years and we need around $50,000 to purchase new inventory and expand our warehouse space. Our monthly revenue is approximately $35,000. Could you let me know what the next steps are and whether we qualify?",
    status: "new",
    tags: ["email-inquiry"],
    customFields: {},
  ...
  },
  {
    ...
    source: "sms",
    sourceDetails:
      "SMS from +1-555-0102 received Aug 19 11:00 AM\n\nHey! Saw your ad. We're a tech startup looking for about $30k in seed funding. Been in business 8 months, already have paying customers. Can you help? — Sarah",
    intent: "startup_funding",
    fundingAmount: "$30,000",
    message:
      "Hey! Saw your ad. We're a tech startup looking for about $30k in seed funding. Been in business 8 months, already have paying customers. Can you help?",
    status: "new",
    tags: ["sms-inquiry"],
    customFields: {},
  ...
  },
  {
    ...
    firstName: "Mike",
    lastName: "Brown",
    email: "mike@restaurantco.com",
    phone: "+1-555-0103",
    company: "Restaurant Co",
    source: "facebook",
    sourceDetails:
      "Facebook Messenger DM — Mike Brown (@mike.brown.restaurantco)\nReceived Aug 19 12:00 PM\n\nHello! I run a restaurant and I need equipment financing for about $25,000. I need to replace our commercial kitchen equipment — oven, refrigerators, and a new POS system. Business has been running 5 years with steady income. Is this something BusinessBlum can help with? Please reach out ASAP.",
  ...
  },
  {
    ...
    source: "instagram",
    sourceDetails:
      "Instagram DM — @lisadavis_fashion\nReceived Aug 19 1:00 PM\n\nHi there! I found you through a sponsored post. I own a boutique fashion store and we're going through a slow season but have big orders coming in Q4. I need around $20,000 in working capital to cover payroll and restock inventory before the holiday rush. My store has been open 2 years. Can I apply?",
  ...
  },
  {
    ...
    source: "twitter",
    sourceDetails:
      "Twitter/X DM — @davidwilson_biz\nReceived Aug 19 2:00 PM\n\nHey, reached out after seeing your tweet about SBA loans. I run a 4-year-old consulting firm and we want to apply for an SBA loan of around $100,000 to hire 3 more consultants and open a second office. We have clean books and strong revenue. What does the process look like on your platform?",
    intent: "sba_loan",
  ...
  },
  {
    ...
    source: "linkedin",
    sourceDetails:
      "LinkedIn Message — Emma Taylor, CEO at Taylor Marketing Agency\nReceived Aug 19 3:00 PM\n\nHello, I was referred to BusinessBlum by a colleague. We are a 6-year-old marketing agency looking for a construction loan of $200,000 to build out a new office space we're leasing. We have a signed lease agreement and strong annual revenue of $1.2M. I'd love to understand the eligibility requirements and how fast approval can happen. Please connect me with the right person.",
    intent: "construction_loan",
    fundingAmount: "$200,000",
    message:
      "Hello, I was referred to BusinessBlum by a colleague. We are a 6-year-old marketing agency looking for a construction loan of $200,000 to build out a new office space we're leasing. We have a signed lease agreement and strong annual revenue of $1.2M. I'd love to understand the eligibility requirements and how fast approval can happen.",
    status: "new",
    tags: ["linkedin"],
    customFields: {},
  ...
  },
  {
    ...
    firstName: "James",
    lastName: "Anderson",
    email: "james@retailshop.com",
    phone: "+1-555-0107",
    company: "Retail Shop",
    source: "whatsapp",
    sourceDetails:
      "WhatsApp message from +1-555-0107 (James Anderson)\nReceived Aug 19 4:00 PM\n\nHi! I have a retail shop that took out 3 separate small business loans over the past 2 years and the monthly payments are killing my cash flow. I'm looking to consolidate them into one loan — total outstanding is about $40,000. Would BusinessBlum be able to help me refinance these into a single lower monthly payment? Thanks",
    intent: "debt_consolidation",
    fundingAmount: "$40,000",
    message:
      "Hi! I have a retail shop that took out 3 separate small business loans over the past 2 years and the monthly payments are killing my cash flow. I'm looking to consolidate them into one loan — total outstanding is about $40,000. Would BusinessBlum be able to help me refinance these into a single lower monthly payment?",
    status: "new",
    tags: ["whatsapp"],
    customFields: {},
